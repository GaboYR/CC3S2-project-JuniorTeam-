...
| 1 Iniciar sesión             | 1.3 | Fallo del inicio de sesión con una constraseña inválida. Dado un username con una constraseña no asociada a este mismo cuando intento iniciar sesión con estas credenciales Entonces el sistema no debería permitirme acceder al juego y debería mostrar un mensaje de error indicando "Contraseña incorrecta".| En progreso | Juan Silva |
